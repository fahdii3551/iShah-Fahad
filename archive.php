...
<div class="aali_tm_page_wrapper">
    <div class="aali_tm_page_title">
        <div class="container">
            <h3><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'aali' ), get_the_date() );
                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'aali' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'aali' ) ) );
                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'aali' ), get_the_date( _x( 'Y', 'yearly archives date format', 'aali' ) ) );
                        else :
                            echo esc_html__( 'Archives', 'aali' );
                        endif;?></h3>
        </div>
