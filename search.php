...
<div class="aali_tm_page_wrapper">
    <div class="aali_tm_page_title">
        <div class="container">
            <h3><?php printf( esc_html__( 'Search Results for: %s', 'aali' ), get_search_query() ); ?></h3>
        </div>
                    ...
                    <div class="blog_list">
                        <ul>
                            ...
                            <div class="search-custom" >
                                <h4>
                                    <?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'aali' ) ;?>
                                </h4>
                                <?php get_search_form();  ?>
                            </div> 
                            <?php endif;?>
