...
<div class="aali_tm_all_wrap" data-magic-cursor="show">     
    ...
    <div class="aali_tm_mobile_menu">
        <div class="mobile_menu_inner">
            <div class="mobile_in">
                ...
                <div class="logo">
                    <a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_attr($aali_redux_demo['logo']['url']);?>" alt="" /></a>
                </div>
                <?php }else{?>
                <div class="logo">
                    <a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo get_template_directory_uri();?>/img/logo/logo.png" alt="" /></a>
                </div>
                <?php } ?>
                <div class="trigger">
        ...
        <div class="dropdown">
            <div class="dropdown_inner">
                <?php 
                    wp_nav_menu( 
                        array( 
                            'theme_location' => 'primary_blog_dark',
                            'container' => '',
                            'menu_class' => '', 
                            'menu_id' => '',
                            'menu'            => '',
    ...
    <!-- /MOBILE MENU -->
    <!-- HEADER -->
    <div class="aali_tm_header" data-position="fixed" data-skin="translight">
        <div class="container">
            <div class="inner">
                <?php if(isset($aali_redux_demo['logo']['url']) && $aali_redux_demo['logo']['url'] != ''){?> 
                <div class="logo">
