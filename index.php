...
<div class="aali_tm_page_wrapper">
    <div class="aali_tm_page_title">
        <div class="container">
            <h3><?php if(isset($aali_redux_demo['blog_title'])){?>
                    <?php echo esc_attr($aali_redux_demo['blog_title']);?>
                    <?php }else{?>
                    <?php echo esc_html__( 'Blog', 'aali' ); } ?></h3>
            <div class="aali_tm_breadcrubms">
                <span><a class="active" href="<?php echo esc_url(home_url('/')); ?>"><?php echo esc_html__( 'Home', 'aali' );?></a></span>
                <span><?php if(isset($aali_redux_demo['blog_title'])){?>
                    <?php echo esc_attr($aali_redux_demo['blog_title']);?>
                    <?php }else{?>
                    <?php echo esc_html__( 'Blog', 'aali' ); } ?></span>
            </div>
        </div>
